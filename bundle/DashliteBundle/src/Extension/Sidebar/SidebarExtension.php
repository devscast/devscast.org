...
use Devscast\Bundle\DashliteBundle\Extension\Sidebar\Type\SidebarGroup;
use Devscast\Bundle\DashliteBundle\Extension\Sidebar\Type\SidebarHeader;
use Devscast\Bundle\DashliteBundle\Extension\Sidebar\Type\SidebarLink;
...
class SidebarExtension extends AbstractExtension
{
    ...
    public function __construct(
        ...
        $this->defaultSidebarClass = (string) $this->container->getParameter('devscast.administration.default_sidebar');
    }
