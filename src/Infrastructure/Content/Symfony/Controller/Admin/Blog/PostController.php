...
use Application\Content\Command\Blog\DeletePostCommand;
...
use Infrastructure\Content\Doctrine\Repository\Blog\PostRepository;
use Infrastructure\Content\Symfony\Form\Blog\CreatePostForm;
use Infrastructure\Content\Symfony\Form\Blog\UpdatePostForm;
 ...
 */
#[AsController]
#[Route('/admin/content/posts', 'admin_content_blog_post_')]
