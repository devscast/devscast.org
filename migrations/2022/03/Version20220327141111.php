...
/**
 * Class Version20220327141111
 *
 * @author bernard-ng <bernard@devscast.tech>
 */
final class Version20220327141111 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'add user, login_attempt and reset_password_token table';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, uuid VARCHAR(36) NOT NULL, name VARCHAR(80) NOT NULL, username VARCHAR(30) NOT NULL, job_title VARCHAR(150) DEFAULT NULL, biography LONGTEXT DEFAULT NULL, gender ENUM(\'M\', \'F\', \'O\'), email VARCHAR(180) DEFAULT NULL, phone_number VARCHAR(15) DEFAULT NULL, country VARCHAR(3) DEFAULT \'CD\' NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(4096) DEFAULT NULL, is_email_verified TINYINT(1) DEFAULT 0 NOT NULL, is_phone_number_verified TINYINT(1) DEFAULT 0 NOT NULL, is_banned TINYINT(1) DEFAULT 0 NOT NULL, banned_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', last_login_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', last_login_ip DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', github_id VARCHAR(255) NOT NULL, facebook_id VARCHAR(255) NOT NULL, google_id VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_8D93D6496B01BC5B (phone_number), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
